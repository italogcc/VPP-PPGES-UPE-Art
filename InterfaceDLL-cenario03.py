...
dss_arquivo = str(r"D:\Projetos\opendss\VPP-PPGES-UPE-Art\cenario03.dss").strip()
...
dss.text("Export monitors carga_potencia")
dss.text("Plot monitor object=carga_potencia channels=(1 3 5)")
dss.text("Export monitors carga")
dss.text("Plot monitor object=carga channels=(1 3 5)")
